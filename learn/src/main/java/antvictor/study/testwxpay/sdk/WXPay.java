package antvictor.study.testwxpay.sdk;

import antvictor.study.testwxpay.sdk.WXPayConstants.SignType;
...
public class WXPay {
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        String signTypeInData = reqData.remove(WXPayConstants.FIELD_SIGN_TYPE);
        SignType signType;
