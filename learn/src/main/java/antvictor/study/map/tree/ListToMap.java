...
import antvictor.study.map.Test3;
...
public class ListToMap {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
          testList.add(new Test3("antvictor1", 1, 1001));
          testList.add(new Test3("antvictor2", 2, 1002));
          testList.add(new Test3("antvictor3", 3, 1003));
          testList.add(new Test3("antvictor4", 3, 1001));
          testList.add(new Test3("antvictor5", 3, 1002));
          testList.add(new Test3("antvictor6", 4, 1002));
        }
